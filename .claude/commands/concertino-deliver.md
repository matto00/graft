---
description: Drive the graft ticket-delivery workflow end-to-end for a ticket (Concertino orchestrator).
---
...
`$ARGUMENTS` contains a ticket id (e.g. `ABC-123`). Extract it.
